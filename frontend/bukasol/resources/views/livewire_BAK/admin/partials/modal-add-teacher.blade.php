        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-around">
                    ...
                    <button class="btn btn-outline-success" data-bs-dismiss="modal" type="button" onclick="Livewire.dispatch('switchView', { view: 'admin.add-teacher' })">Tambah Manual</button>
                </div>
            </div>
        </div>
    </div>
