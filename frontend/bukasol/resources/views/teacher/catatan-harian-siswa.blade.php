<div class="p-0 m-0">
    ...
    <style>
        #catatanHarianSiswaTable thead th {
            text-align: center;
            vertical-align: middle;
        }

        #catatanHarianSiswaTable tbody td {
            text-align: left;
            vertical-align: middle;
        }

        #catatanHarianSiswaTable tbody td:last-child {
            text-align: center;
        }
                    ...
                    <td>
                        <div class="container-fluid w-100">
                            <div class="d-flex justify-content-center w-100">
                                ...
                                <button class="btn btn-sm btn-primary py-2 me-2" onclick="Livewire.dispatch('switchView', { view: 'teacher.catatan-harian-siswa-detail' })">
                                    <i class="fa fa-eye"></i>
                                </button>
    ...
    <div x-data x-init="$wire.dispatch('viewSwitched', { view: 'teacher.catatan-harian-siswa' })"></div>
</div>
