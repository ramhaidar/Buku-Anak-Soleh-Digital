<div class="p-0 m-0">
    ...
    <style>
        #laporanBacaanJuz01SiswaTable thead th {
            text-align: center;
            vertical-align: middle;
        }

        #laporanBacaanJuz01SiswaTable tbody td {
            text-align: left;
            vertical-align: middle;
        }

        #laporanBacaanJuz01SiswaTable tbody td:last-child {
            text-align: center;
        }
    ...
    <div class="text-center p-0 m-0 pe-1">
        <div class="row align-items-center mb-4">
            <div class="col container position-relative">
                <h2 class="text-center mb-0">Laporan Bacaan Juz 1 Siswa</h2>
            </div>
                    ...
                    <td>
                        <div class="container-fluid w-100">
                            <div class="d-flex justify-content-center w-100">
                                ...
                                <button class="btn btn-sm btn-primary py-2 me-2" onclick="Livewire.dispatch('switchView', { view: 'teacher.laporan-bacaan-juz01-detail' })">
                                    <i class="fa fa-eye"></i>
                                </button>
