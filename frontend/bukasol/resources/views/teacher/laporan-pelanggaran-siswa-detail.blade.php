...
@section('content_3')
    <div class="p-0 m-0">
        <div class="text-center p-0 m-0">
            <h2 class="text-center mb-4">Detail Pelanggaran Siswa {{ $violationReport->student->user->name }}</h2>
        </div>
            ...
            <div class="p-4 rounded w-75">
                <form id="detailLaporanPelanggaran">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control rounded-3 border-dark border-2" id="date" name="date" type="text" value="{{ $violationReport->time_stamp }}" readonly disabled>
                    </div>
