            ...
            <div class="p-4 rounded w-50">
                <form action="#" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control rounded-5 border-dark border-2" id="jenis_gerakan" name="jenis_gerakan" type="text" value="Adzan" placeholder="Jenis Gerakan..." readonly disabledrequired>
                    </div>
