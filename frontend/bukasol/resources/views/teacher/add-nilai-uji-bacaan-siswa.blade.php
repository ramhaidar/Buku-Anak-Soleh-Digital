...
@section('content_3')
    <div class="p-0 m-0">
        <div class="text-center p-0 m-0">
            <h2 class="text-center mb-4">Tambah Nilai Uji Bacaan Siswa</h2>
        </div>
            ...
            <div class="p-4 rounded w-75">
                <form action="{{ route('prayer-recitation.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control rounded-5 border-dark border-2" id="jenis_bacaan" name="jenis_bacaan" type="text" placeholder="Jenis Bacaan..." required>
                    </div>
