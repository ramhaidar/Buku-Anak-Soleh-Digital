<div class="p-0 m-0">
    <style>
        ...
        #laporanBacaanJuz30SiswaTable th,
        #laporanBacaanJuz30SiswaTable td {
            text-align: center;
    ...
    <div class="text-center p-0 m-0 pe-1">
        <div class="row align-items-center mb-4">
            ...
            <div class="col d-flex justify-content-end align-items-end mt-3 mt-md-0">
                ...
                <button class="btn btn-outline-dark rounded-3" onclick="Livewire.dispatch('switchView', { view: 'student.add-laporan-bacaan-juz30' })">
    ...
    <div x-data x-init="$wire.dispatch('viewSwitched', { view: 'student.laporan-bacaan-juz30' })"></div>

    @include('livewire.student.partials.laporan-bacaan-juz30-delete')
