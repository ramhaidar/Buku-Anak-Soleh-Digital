<div class="p-0 m-0">
    <style>
        ...
        #laporanBacaanJuz29SiswaTable th,
        #laporanBacaanJuz29SiswaTable td {
            text-align: center;
    ...
    <div class="text-center p-0 m-0 pe-1">
        <div class="row align-items-center mb-4">
            <div class="col container position-relative">
                <h2 class="text-center mb-0">Laporan Bacaan Juz 29</h2>
            </div>
            <div class="col d-flex justify-content-end align-items-end mt-3 mt-md-0">
                <button class="btn btn-outline-dark rounded-3 me-2">
                    <i class="fa-solid fa-file-contract me-1"></i>
                    <span class="d-none d-md-inline">Export Bacaan Juz 29</span>
                </button>
                <button class="btn btn-outline-dark rounded-3" onclick="Livewire.dispatch('switchView', { view: 'student.add-laporan-bacaan-juz29' })">
                    ...
                    <td>
                        <div class="container-fluid w-100">
                            <div class="d-flex justify-content-center w-100">
                                <button class="btn btn-sm btn-danger py-2 me-2" data-bs-toggle="modal" data-bs-target="#deleteLaporanBacaanJuz29ConfirmationModal">
    ...
    <div x-data x-init="$wire.dispatch('viewSwitched', { view: 'student.laporan-bacaan-juz29' })"></div>

    @include('livewire.student.partials.laporan-bacaan-juz29-delete')
