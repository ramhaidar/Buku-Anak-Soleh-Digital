...
<div class="modal fade" id="deleteConfirmationModal" aria-labelledby="deleteConfirmationModalLabel" aria-hidden="true" tabindex="-1">
...
<script>
    ...
    function confirmDelete(deleteTeacherId, tableId) {
        ...
        const deleteConfirmationModal = bootstrap.Modal.getInstance(deleteConfirmationModalEl) || new bootstrap.Modal(deleteConfirmationModalEl);
